...
export const solar2lunar = (year, m, d) => lunarCalendar.solar2lunar(year, m, d); // 公历转农历 -- 年份可不传
export const lunar2solar = (year, m, d) => lunarCalendar.lunar2solar(year, m, d); // 农历转公历
