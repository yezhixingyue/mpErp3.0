...
import {
  ...
  Tooltip, Pagination, Upload, Checkbox, RadioGroup, RadioButton, TimeSelect, CheckboxGroup, Tree, Menu, Submenu, MenuItem, ButtonGroup,
...
import { Button as MpButton } from '@/components/common/mpzj-sell-lib/lib';
import Empty from '@/components/common/NewSetupComps/Empty/Empty';

Vue.component('MpButton', MpButton);
Vue.component('MpEmpty', Empty);
