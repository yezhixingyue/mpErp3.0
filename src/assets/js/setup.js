...
// ---------------------------------- ↓  开发平台相关
export const docBaseURL = 'http://192.168.1.92:8090'; // 文档服务器调用接口地址
export const docClientURL = process.env.NODE_ENV === 'development' ? 'http://192.168.2.237:5173/doc' : 'http://192.168.1.92:8050/openPlatform/doc'; // 文章预览地址
