<template>
  <section class="mp-erp-common-comps-formula-table-common-comp-wrap">
    <header>
...
export default {
  ...
  mounted() {
    this.getFormulaList();
    const oTable = document.querySelector('.mp-erp-common-comps-formula-table-common-comp-wrap .mp-erp-common-formula-table-comp-wrap .el-table__body-wrapper');
