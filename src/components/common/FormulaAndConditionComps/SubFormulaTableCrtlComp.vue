...
export default {
  ...
  methods: {
    ...
    async getComparePropertyList() {
      const propertyList = await PropertyClass.getPropertyList(
        { [this.PositionType]: this.PositionID, UseModule: this.CompareUseModule },
        this.api.getFormulaPropertyList,
      );
