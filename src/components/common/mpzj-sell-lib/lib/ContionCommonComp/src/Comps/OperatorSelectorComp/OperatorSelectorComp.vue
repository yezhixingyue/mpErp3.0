  ...
  computed: {
    ...
    showSelectedText() { // 已选择物料显示文字
      if (this.PropertyData.FixedType === 46) {
        return getTreeTextDisplayContent(this.checkList, this.allAdAreaTreeList || [], this.treeType);
      }
      if (this.PropertyData.FixedType === 47) {
