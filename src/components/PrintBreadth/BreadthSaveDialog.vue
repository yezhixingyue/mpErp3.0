      ...
      <el-form-item label="最小物料尺寸：" key="MinMaterialSize">
        <el-col :span="6.6">
          <el-form-item prop="MinMaterialSize.Length">
            <el-input style="width:110px" v-model.trim.number="ruleForm.MinMaterialSize.Length" maxlength="16" placeholder="长"></el-input>
            <span style="margin: 0 10px">X</span>
          </el-form-item>
        </el-col>
        <el-col :span="6.6">
          <el-form-item prop="MinMaterialSize.Width">
            <el-input style="width:110px" v-model.trim.number="ruleForm.MinMaterialSize.Width" maxlength="16" placeholder="宽"></el-input>
      ...
      <el-form-item label="最大物料尺寸：" key="MaxMaterialSize">
        <el-col :span="6.6">
          <el-form-item prop="MaxMaterialSize.Length">
            <el-input style="width:110px" v-model.trim.number="ruleForm.MaxMaterialSize.Length" maxlength="16" placeholder="长"></el-input>
            <span style="margin: 0 10px">X</span>
          </el-form-item>
        </el-col>
        <el-col :span="6.6">
          <el-form-item prop="MaxMaterialSize.Width">
            <el-input style="width:110px" v-model.trim.number="ruleForm.MaxMaterialSize.Width" maxlength="16" placeholder="宽"></el-input>
      ...
      <el-form-item label="允许拼版方式：" prop="ModeList" key="ruleFormModeList">
        <div v-for="it in ruleForm.ModeList" :key="it.key" class="MakeupMode-box">
          ...
          <template v-if="it.checked">
            ...
            <el-input style="width:100px" v-model.trim.number="it.WhiteEdge.Length" maxlength="16" placeholder="长"></el-input>
            <el-input style="width:100px;margin-left:25px" v-model.trim.number="it.WhiteEdge.Width" maxlength="16" placeholder="宽"></el-input>
            <span style="margin-left:10px;color:#a2a2a2">mm</span>
          </template>
        </div>
      </el-form-item>
