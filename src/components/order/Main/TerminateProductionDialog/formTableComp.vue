<template>
  ...
  >
    ...
    <el-table-column prop="Material" min-width="143" label="物料"/>
    <el-table-column prop="Size" min-width="150" label="尺寸"/>
    <el-table-column prop="Number" min-width="79" label="数量"/>
    <el-table-column prop="ChunkCount" min-width="96" label="总块数"/>
    <el-table-column prop="Code" min-width="240" label="含此订单块（尺寸）"/>
    <el-table-column prop="WorkingList" min-width="129" label="已加工工序"/>
