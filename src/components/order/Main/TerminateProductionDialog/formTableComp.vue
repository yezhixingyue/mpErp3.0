<template>
  ...
  >
    <el-table-column prop="ID" min-width="104" label="大版ID"/>
    <el-table-column prop="ID" min-width="143" label="物料"/>
    <el-table-column prop="ID" min-width="150" label="尺寸"/>
    <el-table-column prop="ID" min-width="79" label="数量"/>
    <el-table-column prop="ID" min-width="96" label="总块数"/>
    <el-table-column prop="ID" min-width="240" label="总块数"/>
    <el-table-column prop="ID" min-width="129" label="已加工工序"/>
