...
import { PropertyClass, PropertyUtils, FormulaPanelElementSelectDialog } from '@/components/common/mpzj-sell-lib/lib';

const { AllOperatorList, getTempMaterialListObj, getTempMaterialOptionList, getTempMaterialSelectedListShowText } = PropertyUtils;
