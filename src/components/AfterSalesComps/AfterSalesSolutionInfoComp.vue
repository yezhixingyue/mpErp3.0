<template>
  <section class="after-sales-solution-info-comp">
    ...
    <ul>
      <li>
        <span class="label is-bold">补印：</span><span class="value">湿货、生产质量问题、材料质量问题、晚货</span>
      </li>
      <li>
        <span class="label is-bold">额外增送优惠券：</span><span class="value">订单详情</span>
      </li>
      <li>
        <span class="label is-bold">补充说明：</span><span class="value">订单详情</span>
      </li>
      <li>
        <span class="label is-bold">额外支出：</span><span class="value">订单详情</span>
      </li>
      <li>
        <span class="label is-bold">支出说明：</span><span class="value">订单详情</span>
      </li>
      <li>
