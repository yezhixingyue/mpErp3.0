  ...
  >
    ...
    >
      ...
      <el-form-item label="使用次数：" prop="UseTimes" class="use-times-box" key="GroupUseTimes">
        <el-input style='width:110px' v-model.number.trim="ruleGroupForm.UseTimes.MinValue"></el-input>
        <span>≤ 次数 ≤</span>
        <el-input style='width:110px' v-model.number.trim="ruleGroupForm.UseTimes.MaxValue"></el-input>
      </el-form-item>
