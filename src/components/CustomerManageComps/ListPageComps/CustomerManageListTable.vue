<template>
  <el-table
   ...
   >
    ...
    <el-table-column label="名称" prop="CustomerName" width="100" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column label="经营地址" prop="SellAddressContent" width="144" show-overflow-tooltip></el-table-column>
