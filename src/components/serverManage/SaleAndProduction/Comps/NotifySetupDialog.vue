<template>
  ...
  >
    ...
    <p class="tips-box warning ft-12">
...
import { SaleAndProductionListItemClass, NotifyTypeEnum } from '@/views/serverManage/utils/SaleAndProductionListItemClass';
...
const onOpen = async () => {
  ruleForm.value = new SaleAndProductionListItemClass(props.pageTypeData.curEditItem || undefined);
};
