...
const routes = { // 财务管理
  ...
  children: [
    ...
    ------------------------------------------ */
    {
      ...
      meta: {
        title: '发票开具',
        icon: 'iconfont icon-fapiaokaiju ft-f-14 ml-f-3',
        pageName: 'InvoiceMakeOutListPage',
        requiresAuth: true,
        PermissionInfo: ['PermissionInvoicing', 'HavePomission'],
      },
      component: () => import('../../../views/InvoicePages/InvoiceMakeOutListPage.vue'),
    },
    {
      path: '/InvoiceMakeOutDetail/:invoiceID',
      name: 'InvoiceMakeOutDetail',
      meta: {
        title: '发票开具详情',
        pageName: 'InvoiceMakeOutDetailPage',
        requiresAuth: true,
        PermissionInfo: ['PermissionInvoicing', 'Obj', 'Operate'],
      },
    ...
    },
    {
      ...
      meta: {
        title: '发票资质管理',
        icon: 'iconfont icon-fapiaozizhiguanli',
        pageName: 'InvoiceQualificationManagePage',
        requiresAuth: true,
        PermissionInfo: ['PermissionInvoiceEnterprise', 'HavePomission'],
      },
    ...
    },
    {
      ...
      meta: {
        title: '开票类别',
        icon: 'iconfont icon-kaipiaoleibie',
        pageName: 'InvoiceInfoListPage',
        requiresAuth: true,
        PermissionInfo: ['PermissionInvoiceCategory', 'HavePomission'],
      },
    ...
    },
    {
      ...
      meta: {
        ...
        requiresAuth: true,
        PermissionInfo: ['PermissionInvoiceCategory', 'Obj', 'Operate'],
      },
