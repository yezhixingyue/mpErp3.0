<template>
  <section class="mp-erp-trace-record-page-containner">
    <Header />
    <main class="mp-erp-trace-record-page-main-comp-wrap">
    ...
    <footer>
      <Count
       ...
       center
       >
       <DownLoadExcelComp :configObj="configObj" v-if="localPermission.ExportTrackExcel" />
      </Count>
    </footer>
  </section>
</template>
...
<style lang='scss'>
.mp-erp-trace-record-page-containner {
