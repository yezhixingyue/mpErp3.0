...
import { DisplayTypeEnum, IWorkTimesRightType, WorkTimesMapClass } from './WorkTimesMapClass';
...
const checkList = ref<IWorkTimesRightType[]>([]);
...
const onOpen = () => {
  ...
  checkList.value = t ? [...t.TargetProperty as unknown as IWorkTimesRightType[]] : [];
  getDisplayList();
};
