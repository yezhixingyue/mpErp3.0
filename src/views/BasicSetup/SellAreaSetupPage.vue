...
import SellAreaContentLeft from '../../components/SellAreaSetupComps/Left/SellAreaContentLeft.vue';
import SellAreaContentRight from '../../components/SellAreaSetupComps/Right/SellAreaContentRight';
